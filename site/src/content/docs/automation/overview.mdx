...
<img class="d-block mb-4 img-fluid rounded-3 border" src="/docs/[[config:docs_version]]/assets/img/automation.png" alt="" />
...
<img class="d-block mb-4 img-fluid rounded-3 border" src="/docs/[[config:docs_version]]/assets/img/automation-name.png" alt="" />

### Dropdown button

Click the split button next to the name to open a menu with all automation actions:

<img class="d-block mb-4 img-fluid rounded-3 border" src="/docs/[[config:docs_version]]/assets/img/automation-menu.png" alt="" />
