...
toc: true
aliases:
  - '/docs/3.1/configuration/manual-start/'
  - '/docs/3.x/configuration-settings/manual-start/'
...
<img class="d-block mb-4 img-fluid rounded-3 border" src="/docs/[[config:docs_version]]/assets/img/automation-settings.png" alt="" />

<img class="d-block mb-4 img-fluid rounded-3 border" src="/docs/[[config:docs_version]]/assets/img/automation-settings-manual.png" alt="" />
