...
You can also unpublish directly from [Explore]([[docsref:/automations/explore]]) — type `@me` in its search box to find your own automations, then use each row's **⋮** menu — without opening the automation.
