...
aliases:
  ...
  - '/docs/3.x/action-settings/iframe-first/'
---
...
<ExampleAutomation file="goto" plus>
  Step 1 fails to find its target and jumps straight to step 3.
</ExampleAutomation>

<img class="d-block mb-4 img-fluid rounded-3 border" src="/docs/[[config:docs_version]]/assets/img/step-settings.png" alt="Step Settings" />
