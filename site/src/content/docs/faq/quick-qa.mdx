...
- Shortcuts like Id::, Name::, ClassName::, Selector:: More: [Element Finder]([[docsref:/step/element-finder]])
...
- Value: `MouseEvents::click` More: [Mouse Events]([[docsref:/step-value/mouse-events]])
...
- Finder: the input
- Value: `Paste::Your text` (or Replace/Append/Prepend) More: [Paste]([[docsref:/step-value/paste]])
...
- New tab: `LocationCommand::open=https://...` More: [Location Command]([[docsref:/step-value/location-command]])
