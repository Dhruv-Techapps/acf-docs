...
<img class="d-block mb-4 img-fluid rounded-3 border" src="/docs/[[config:docs_version]]/assets/img/automations-reorder.png" alt="" />

<Callout type="info">Priority matters: when multiple automations match the same URL, the first match in the list wins.</Callout>
