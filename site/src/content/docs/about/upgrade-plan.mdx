...
PLUS and PRO can be billed **monthly** or **yearly**. Use the **Monthly / Yearly** toggle above the plan cards in the **Subscription** section of the extension's options page to switch — the price on each card updates to match:
