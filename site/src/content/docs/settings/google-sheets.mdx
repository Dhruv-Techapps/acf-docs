...
<img class="d-block mb-4 img-fluid rounded-3 border" src="/docs/[[config:docs_version]]/assets/img/global-settings-google-sheets.png" alt="" />
...
<Callout type="danger">
  ...
  <img class="d-block mb-4 img-fluid rounded-3 border" src="/docs/[[config:docs_version]]/assets/img/global-settings-google-sheets-error.png" alt="" />
</Callout>
